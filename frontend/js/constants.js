const contractAddress = "0x9341fa24438C78C43847A4ce83c3913d41aeB2cd"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to Starsier Club";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Starsier Club NFT Project is a decentralized';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting is Open";
